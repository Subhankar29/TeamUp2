...
public class Literary_people extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.literary_people);
    ...
    protected void onStart() {
        ...
        Firebase messagesRef = Ref.child("user-interests").child("literary");
        ...
        mPeopleList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent nxt = new Intent(Literary_people.this, Literary_ppl_info.class);
