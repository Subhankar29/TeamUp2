...
/**
 * Created by venkateshtata on 31/10/16.
 */

public class Coding_people extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        Firebase messagesRef = Ref.child("user-interests").child("coding");
        ...
        mPeopleList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent nxt = new Intent(Coding_people.this, Coding_ppl_info.class);
